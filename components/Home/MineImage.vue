<template>
  <div class="row">
    <div class="col-md-12 col-lg-4 text-white text-center">
      <h3>前端工程师</h3>
      <p>
        拥有两年前端工作经验,具备CMS开发经验,能独立完成建站项目并部署到服务器上,擅长用宝塔进行部署。熟悉并有实际经验优化vue seo优化并能搭建项目放到服务器运行。
      </p>
      <ul class="p-0">
        <li class="list-unstyled">
          常用UI框架:Bootstrap-Vue Vuetify
        </li>
      </ul>
      <front-end-engineer />
    </div>
    <div id="userimg" class="col-md-12 col-lg-4 text-center">
      <img src="@/static/img/mine.jpg" width="300" style="border-radius:50%">
    </div>
    <div class="col-md-12 col-lg-4 text-white text-center">
      <h3 class="mb-2">
        开发运维
      ...
      <div class="mt-3">
        ...
        <ul class="list-unstyled d-flex flex-wrap p-0">
          ...
          <li>
            ...
            <p style="font-size:13px">
              类似做github项目 用vuejs+bootstrap技术写 参与git分支图逻辑参与与实现，merge合并创建根据后端返回的数据进行前端页面展示。利用nuxtjs ssr渲染进行project页面进行seo优化，利用docker打包成镜像交付给后端进行自动化部署
            </p>
          </li>
        </ul>
      </div>
...
import FrontEndEngineer from './FrontEndEngineer.vue'
export default {
  name: '',
